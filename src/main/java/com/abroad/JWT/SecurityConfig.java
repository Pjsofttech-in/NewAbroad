...
import com.abroad.Exception.CustomAuthenticationEntryPoint;
        ...
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers("/stafflogin","/userLogin","/permissionForUser","/getBranchCodeByUserEmail","/getAllBlogs","/getBlogByTitle","/createPartner",
                                ...
                                "/getAllStreams","/searchUniversities","/searchStates","/searchCities","/searchColleges","/searchCountries","/searchStreams","/getBlogById/{id}").permitAll()
